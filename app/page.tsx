          ...
          <div className="footer-content">
            ...
            <div className="footer-right">
              <div className="social-icons">
                <a href="https://github.com/GannojiSathvik" target="_blank" className="social-icon">
                ...
                <a href="https://www.linkedin.com/in/gannoji-sathvik-664b052a5/" target="_blank" className="social-icon">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                    <path
